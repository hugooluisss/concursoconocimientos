<?php /* Smarty version Smarty-3.1.11, created on 2016-08-15 10:06:00
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			<div class="login-logo">
				<a href="index.php">Concurso de <b>Conocimientos</b></a>
			</div><!-- /.login-logo -->
...
img/logo.png" class="img-rounded"/>
				...
				<form action="#" id="frmLogin" method="post">
					...
					<div class="form-group has-feedback">
						<input type="password" class="form-control" placeholder="NIP" id="txtPass" name="txtPass">
