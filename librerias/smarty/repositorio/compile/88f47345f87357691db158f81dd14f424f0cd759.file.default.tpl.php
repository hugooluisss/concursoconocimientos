	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="panelPrincipal" class="logo">
				...
				<span class="logo-mini"><b>IEBO</b>Admin</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>IEBO</b> panel de Admon</span>
			</a>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small><?php echo $_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getCorreo();?>
</small>
									</p>
								</li>
								<!-- Menu Body -->
